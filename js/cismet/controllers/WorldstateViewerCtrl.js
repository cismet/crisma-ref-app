angular.module(
    ...
    [
        ...
        '$timeout',
        '$route',
        function ($scope, Worldstates, $timeout, $route) {
            $scope.isLoading = true;
            Worldstates.get({wsId: $route.current.params.wsId}, function (worldstate) {
                ...
                $scope.worldstateHeaderProvided = ($scope.worldstate.renderingdescriptor && $scope.worldstate.renderingdescriptor.worldstateHeader) || false;
//                $timeout(function () {
